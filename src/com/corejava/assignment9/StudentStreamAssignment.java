...
public class StudentStreamAssignment {
    ...
    public static void main(String[] args) {
        ...
        students.stream()
                .max(Comparator.comparingDouble(s -> s.percentage))
        ...
        System.out.println(
                students.stream()
                        .collect(Collectors.groupingBy(s -> s.department,
                                Collectors.averagingDouble(s -> s.percentage)))
        );
        ...
        System.out.println("\n10. Male and Female Computer Science students:");
        System.out.println(
                students.stream()
                        .filter(s -> s.department.equals("Computer Science"))
                        .collect(Collectors.groupingBy(s -> s.gender, Collectors.counting()))
